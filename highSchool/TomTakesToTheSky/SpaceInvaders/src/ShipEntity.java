...
public class ShipEntity extends Entity {
  ...
  private long immuneInterval = 2000;
   ...
   */
   public void collidedWith(Entity other) {
	   ...
	   if (other instanceof EnemyEntity) {
		 ...
		 // if touched within 2000 ms don't lose a life
    	 if ((System.currentTimeMillis() - lastTouch) < immuneInterval){
             return;
           } // if

           // otherwise change time of last touch
           lastTouch = System.currentTimeMillis();
    	 
         // keeps track of lives lost and shipEntity's sprite
    	 if (game.lifeCounter == 2) {
    		 game.notifyDeath();
    		 game.lifeCounter++;
    	 } else if (game.lifeCounter == 1) {
    		 game.shipState = "T";
    		 game.lifeCounter++;
    	 } else {
    		 game.shipState = "ST";
